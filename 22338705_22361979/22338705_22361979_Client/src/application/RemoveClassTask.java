...
public class RemoveClassTask extends Task<String>{
	
    private final String moduleCode;
    private final String classData;

    public RemoveClassTask(String moduleCode, String classData) {
    ...
    protected String call() throws Exception {
        try {
            return sendClassData("REMOVE_CLASS", moduleCode, classData);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
